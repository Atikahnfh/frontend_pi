            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 mb-12 md:w-1/3">
                    ...
                    <ul class="text-slate-300">
                        ...
                        <li>
                            <a href="#portfolio" class="inline-block text-base hover:text-primary mb-3">Beasiswa</a>
                        </li>
                        <li>
                            <a href="#clients" class="inline-block text-base hover:text-primary mb-3">Universitas</a>
                        </li>
                        <li>
